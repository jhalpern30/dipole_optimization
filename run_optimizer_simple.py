...
run_dir = os.path.join(script_dir, '../outputs/2024_11_20_larger_gaps')
...
# Vacuum Vessel
VV_a = 0.27                   # minor radius of vacuum vessel
...
win_size_over_gap = 2        # Ratio of dipole width to gap distance, dipole size will be approximately win_size_over_gap * fil_to_fil_distance
